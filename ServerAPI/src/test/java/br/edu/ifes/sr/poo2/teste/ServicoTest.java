...
public class ServicoTest {
	...
	public void getListServico() throws Exception
	{
		...
		{
			System.out.println("Categoria:Nome:"+servico.getCategoria().getNome());
			System.out.println("Categoria:Descricao:"+servico.getCategoria().getDescricao());
			System.out.println("Servico:URL:"+servico.getUrl());
			System.out.print("-----------");
		}
